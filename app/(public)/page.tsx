...
export default function LandingPage() {
  return (
    <>
      ...
      <section id="promo" className="bg-white py-24 px-6 overflow-hidden relative">
      ...
      <Suspense fallback={<div className="py-32 flex items-center justify-center text-[#D4A017] font-bold">Cargando testimonios...</div>}>
         <ReviewsSection />
      </Suspense>
