      ...
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        {icon && (
          <div className="relative shrink-0">
            ...
            <div className="relative flex h-8 w-8 sm:h-11 sm:w-11 items-center justify-center rounded-xl sm:rounded-xl bg-[#0F0A4D]/5 border border-gray-100/50 text-[#0F0A4D] group-hover:bg-[#0F0A4D] group-hover:text-white group-hover:scale-110 transition-all duration-500 shadow-sm overflow-hidden text-xs sm:text-sm">
        ...
        <div className="space-y-0.5 sm:space-y-1 min-w-0 flex-1 overflow-visible group-hover:translate-x-1 transition-transform duration-500">
          <div className="flex items-center gap-1 sm:gap-1.5 min-w-0">
            <p className="text-[8px] sm:text-[9px] font-black text-gray-400 uppercase tracking-[0.12em] sm:tracking-[0.15em] whitespace-nowrap overflow-hidden">
              {title}
            </p>
            {trend && (
              <div className={cn("inline-flex shrink-0 items-center px-1 py-0.5 rounded-full text-[7px] sm:text-[8px] font-black transition-colors uppercase tracking-tight", trendColor)}>
                {trendIcon}
              </div>
            )}
          </div>
